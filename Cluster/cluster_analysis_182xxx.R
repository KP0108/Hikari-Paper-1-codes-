...
data_motion_Morning <- Minami_182_Motion_10min[which(Minami_182_Motion_10min$Day.period=="Morning"),c(1:15,18)]

data_power_Morning <- minami_182_power_processed[which(minami_182_power_processed$Day.period=="Morning"),c(4:8,10)]

data_CO2_Morning <- minami_182_indoor_processed[which(minami_182_indoor_processed$Day.period=="Morning"),22]


data_light_Morning <- minami_182_Light_processed[which(minami_182_Light_processed$Day.period=="Morning"),10]


data_morning <- cbind(data_motion_Morning,data_CO2_Morning,data_light_Morning,data_power_Morning)
...
data_morning_H <- data_morning[which(data_morning$day_index_num %in% b_1),]
data_morning_L <- data_morning[which(data_morning$day_index_num %in% b_2),]
data_morning_VL <- data_morning[which(data_morning$day_index_num %in% b_3),]
...
Morn_L_bins_Power <- discretizeUnsupervised(data_morning_H$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                          
                                          categories = 4, method = "Frequency")

Morn_L_bins_Light <- discretizeUnsupervised(data_morning_H$data_light_Morning, labels = TRUE, infinite_bounds = FALSE,
...
data_morning_H$motion_label[which(data_morning_H$motion_total >=1 & data_morning_H$motion_total <=4)] <- "Less movement"

data_morning_H$motion_label[which(data_morning_H$motion_total >=5)] <- "frequent movement"
...
Morn_L_bins_Power <- discretizeUnsupervised(data_morning_L$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                            
                                            categories = 4, method = "Frequency")

Morn_L_bins_Light <- discretizeUnsupervised(data_morning_L$data_light_Morning, labels = TRUE, infinite_bounds = FALSE,
...
data_morning_L$motion_label[which(data_morning_L$motion_total >=1 & data_morning_L$motion_total <=3)] <- "Less movement"

data_morning_L$motion_label[which(data_morning_L$motion_total >=4)] <- "frequent movement"
...
Morn_L_bins_Power <- discretizeUnsupervised(data_morning_VL$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                            
                                            categories = 4, method = "Cluster")

Morn_L_bins_Light <- discretizeUnsupervised(data_morning_VL$data_light_Morning, labels = TRUE, infinite_bounds = FALSE,
...
data_motion_Noon <- Minami_182_Motion_10min[which(Minami_182_Motion_10min$Day.period=="Noon"),c(1:15,18)]

data_power_Noon <- minami_182_power_processed[which(minami_182_power_processed$Day.period=="Noon"),c(4:8,10)]

data_CO2_Noon <- minami_182_indoor_processed[which(minami_182_indoor_processed$Day.period=="Noon"),22]


data_light_Noon <- minami_182_Light_processed[which(minami_182_Light_processed$Day.period=="Noon"),10]


data_Noon <- cbind(data_motion_Noon,data_CO2_Noon,data_light_Noon,data_power_Noon)
...
data_Noon_M <- data_Noon[which(data_Noon$day_index_num %in% b_1),]
data_Noon_L <- data_Noon[which(data_Noon$day_index_num %in% b_2),]
data_Noon_H <- data_Noon[which(data_Noon$day_index_num %in% b_3),]
data_Noon_VL <- data_Noon[which(data_Noon$day_index_num %in% b_4),]
...
data_motion_Afternoon <- Minami_182_Motion_10min[which(Minami_182_Motion_10min$Day.period=="Afternoon"),c(1:15,18)]

data_power_Afternoon <- minami_182_power_processed[which(minami_182_power_processed$Day.period=="Afternoon"),c(4:8,10)]

data_CO2_Afternoon <- minami_182_indoor_processed[which(minami_182_indoor_processed$Day.period=="Afternoon"),22]


data_light_Afternoon <- minami_182_Light_processed[which(minami_182_Light_processed$Day.period=="Afternoon"),10]


data_Afternoon <- cbind(data_motion_Afternoon,data_CO2_Afternoon,data_light_Afternoon,data_power_Afternoon)
...
data_Afternoon_VL <- data_Afternoon[which(data_Afternoon$day_index_num %in% b_1),]
data_Afternoon_L <- data_Afternoon[which(data_Afternoon$day_index_num %in% b_2),]
data_Afternoon_M <- data_Afternoon[which(data_Afternoon$day_index_num %in% b_3),]
...
data_motion <- Minami_182_Motion_10min[which(Minami_182_Motion_10min$Day.period=="Evening"),c(1:15,18)]

data_power <- minami_182_power_processed[which(minami_182_power_processed$Day.period=="Evening"),c(4:8,10)]

data_CO2 <- minami_182_indoor_processed[which(minami_182_indoor_processed$Day.period=="Evening"),22]


data_light <- minami_182_Light_processed[which(minami_182_Light_processed$Day.period=="Evening"),10]


data_evening <- cbind(data_motion,data_CO2,data_light,data_power)
...
data_evening_M <- data_evening[which(data_evening$day_index_num %in% b_1),]
data_evening_VL <- data_evening[which(data_evening$day_index_num %in% b_2),]
data_evening_H <- data_evening[which(data_evening$day_index_num %in% b_3),]
data_evening_L <- data_evening[which(data_evening$day_index_num %in% b_4),]
...
Eve_LowActivity_bins_Power <- discretizeUnsupervised(data_evening_L$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                                     
                                                     categories = 4, method = "Cluster")

Eve_LowActivity_bins_Light <- discretizeUnsupervised(data_evening_L$data_light, labels = TRUE, infinite_bounds = FALSE,
...
data_evening_L$motion_label[which(data_evening_L$motion_total >=1 & data_evening_L$motion_total <=2)] <- "Less movement"

data_evening_L$motion_label[which(data_evening_L$motion_total >2)] <- "frequent movement"
...
Eve_VeryLowActivity_bins_Power <- discretizeUnsupervised(data_evening_VL$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                                         
                                                         categories = 4, method = "Cluster")

Eve_VeryLowActivity_bins_Light <- discretizeUnsupervised(data_evening_VL$data_light, labels = TRUE, infinite_bounds = FALSE,
...
data_motion_Night <- Minami_182_Motion_10min[which(Minami_182_Motion_10min$Day.period=="Night"),c(1:15,18)]

data_power_Night <- minami_182_power_processed[which(minami_182_power_processed$Day.period=="Night"),c(4:8,10)]

data_CO2_Night <- minami_182_indoor_processed[which(minami_182_indoor_processed$Day.period=="Night"),22]


data_light_Night <- minami_182_Light_processed[which(minami_182_Light_processed$Day.period=="Night"),10]
...
data_Night_L <- data_Night[which(data_Night$day_index_num %in% b_2),]
data_Night_M <- data_Night[which(data_Night$day_index_num %in% b_3),]
...
Night_L_bins_Power <- discretizeUnsupervised(data_Night_L$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                            
                                              categories = 4, method = "Cluster")

Night_L_bins_Light <- discretizeUnsupervised(data_Night_L$data_light_Night, labels = TRUE, infinite_bounds = FALSE,
                                            
                                            categories = 4, method = "Cluster")

Night_L_bins_CO2 <- discretizeUnsupervised(data_Night_L$data_CO2_Night, labels = TRUE, infinite_bounds = FALSE,
...
Night_M_bins_Power <- discretizeUnsupervised(data_Night_M$Total.KPWR, labels = TRUE, infinite_bounds = FALSE,
                                             
                                             categories = 4, method = "Frequency")

Night_M_bins_Light <- discretizeUnsupervised(data_Night_M$data_light_Night, labels = TRUE, infinite_bounds = FALSE,
...
data_Night_M$motion_Label[which(data_Night_M$motion_total >=1 & data_Night_M$motion_total <=3)] <- "Less movement"

data_Night_M$motion_Label[which(data_Night_M$motion_total >3)] <- "frequent movement"
